...
export const authenticateError = createAction('[Auth] Login Error', props<{ error: string; username?: string }>());
export const autoLogin = createAction('[Auth] Auto Login', props<{ apiKey: string; username: string; rememberMe: boolean }>());
